...
def main():
    ...
    try:
        ...
        # Load constraints
        with open("./payload_drop/risk_constraints.json", "r") as f:
        ...
        print(f">> Estimated Risk of Ruin (Drawdown > {mc['drawdown_limit_used']}%): {mc['risk_of_ruin'] * 100:.2f}%")
        print(f">> Simulated Average Max Drawdown: {mc['average_max_drawdown']:.2f}%")
        print(f">> Simulated Peak Drawdown: {mc['peak_simulated_drawdown']:.2f}%")
